...
@section('content')
    ...
    @else
        <div class="container-fluid h-100">
            <form class="form-horizontal" action="{{ route('teacher-course') }}" method="GET" enctype="multipart/form-data">
                <div class="form-row justify-content-between">
                    <div class="col-sm-4 mb-3">
                        <div class="form-label-group in-border mb-1">
                            <select id="period" onchange="periodChange()" class="form-control form-control-mb select2" id="myFancyDropdown" style="width: 100%;"
                                name="period">
