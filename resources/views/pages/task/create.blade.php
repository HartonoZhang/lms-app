...
@section('content')
    <div class="container-fluid h-100">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action={{ route('create-task', $classroom->id) }} method="POST"
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="form-label-group in-border mb-1">
                                <input type="text" id="title" class="form-control form-control-mb"
                                    placeholder="Teacher" name="teacher_id" value="{{ old('teacher') }}" hidden />
                                <input type="text" id="title" class="form-control form-control-mb"
                                    placeholder="Teacher" name="teacher" value="{{ old('teacher', $teacher->user->name) }}"
                                    readonly />
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="form-label-group in-border mb-1">
                                <input type="datetime-local" id="deadline" class="form-control form-control-mb"
                                    placeholder="Start Time" name="deadline" value="{{ old('deadline') }}" />
